...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=3000&pause=1000&color=3B82F6&vCenter=true&width=600&lines=Building+AI+systems+that+work+in+production;Agentic+systems+%26+multi-agent+RL;Diffusion+models+%2C+XAI+%26+LLM+post-training" alt="Typing SVG" />
...
- Teaching Mistral-7B to reason with GRPO. ZS 41% → SFT 45% → GRPO 52% on GSM8K ([experiment](https://github.com/garg-tejas/teaching-mistral-to-think))

**Systems:**
- RAG-based CS interview prep platform. Structured output pipeline, offline eval cut malformed JSON from ~12% to <1% ([Recall.cs](https://github.com/garg-tejas/recall-cs))
